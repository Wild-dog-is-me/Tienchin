...
!function(e, t) {
  if (e && "undefined" != typeof document) {
    ...
    if (o) {
      var a = w.indexOf(i);
      -1 === a && (a = w.push(i) - 1, C[a] = {}), n = C[a] && C[a][r] ? C[a][r] : C[a][r] = u();
    } else
      n = u();
...
var S = defineComponent({ name: "echarts", props: O(O({ option: Object, theme: { type: [Object, String] }, initOptions: Object, updateOptions: Object, group: String, manualUpdate: Boolean }, _), z), emits: {}, inheritAttrs: false, setup: function(t, i) {
  var a = i.attrs, p = shallowRef(), b2 = shallowRef(), _2 = shallowRef(), E2 = inject("ecTheme", null), A2 = inject("ecInitOptions", null), z2 = inject("ecUpdateOptions", null), L2 = toRefs(t), w2 = L2.autoresize, C2 = L2.manualUpdate, U2 = L2.loading, D2 = L2.loadingOptions, k2 = computed(function() {
  ...
  var I = null;
  watch(C2, function(n) {
    "function" == typeof I && (I(), I = null), n || (I = watch(function() {
      return t.option;
    }, function(e, t2) {
      e && (b2.value ? b2.value.setOption(e, O({ notMerge: e !== t2 }, P.value)) : R());
    }, { deep: true }));
  ...
  }(b2, w2, p), onMounted(function() {
    R();
  }), onBeforeUnmount(function() {
    T && p.value ? p.value.__dispose = F : F();
  }), O({ chart: b2, root: p, setOption: function(e, n) {
    t.manualUpdate && (_2.value = e), b2.value ? b2.value.setOption(e, n || {}) : R(e);
  }, nonEventAttrs: H }, N);
}, render: function() {
